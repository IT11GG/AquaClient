// File: src/main/java/com/drastic193/aquaclient/gui/DeltaClickGuiScreen.java
...
public class DeltaClickGuiScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // Main GUI panels with delta-style design
    ...
    private void renderSettingsPanel(DrawContext context, int mouseX, int mouseY) {
        ...
        if (hoveredModule >= 0) {
            ...
            context.drawText(mc.textRenderer, "Delta Style GUI", panelX + 10, panelY + 95,
                    TEXT_DISABLED.getRGB(), false);
    ...
    private void renderWatermark(DrawContext context) {
        ...
        DeltaRenderUtils.drawHolographic(context, this.width - watermarkWidth - 20, 10,
                watermarkWidth + 12, 16, animationTime);

        DeltaRenderUtils.drawRoundedRect(context, this.width - watermarkWidth - 20, 10,
                watermarkWidth + 12, 16, 3,
                new Color(0, 0, 0, 100));

        // Rainbow watermark text with glow
        DeltaRenderUtils.drawRainbowText(context, mc.textRenderer, watermark,
                this.width - watermarkWidth - 14, 14,
                animationTime, 2.0f);

        // Add subtle glow effect
        DeltaRenderUtils.drawGlow(context, this.width - watermarkWidth - 20, 10,
                watermarkWidth + 12, 16, 3,
